...
pdfPath = "/Users/pragalvhasharma/Downloads/Prag GO to Documents/Comp Sci/MY Projects/LLamaIndexRag Agent/env/Data/lectures.pdf"
...
lecturesPDF = PDFReader().load_data(file=pdfPath)
